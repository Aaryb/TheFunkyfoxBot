...
API_ID = int(getenv("API_ID", "15523618"))
API_HASH = getenv("API_HASH", "8979514968543c31a37a3ed8a0726d83")
BOT_TOKEN = getenv("BOT_TOKEN", "5600320195:AAEFUZsFWeMK8TtQRDBRjROIdllyz9_GZAI")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1001682891018"))
OWNER_ID = list(map(int, getenv("SUDO_USERS", "6196151348 5709622852 5807975896").split()))
